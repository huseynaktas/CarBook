using CarBook_1.Dto.TestimonialDtos;
...
namespace CarBook_1.WebUI.Areas.Admin.Controllers
{
    ...
    public class AdminTestimonialController : Controller
    {
        ...
        public string apiConnectedUrl = "https://localhost:7174/api/Testimonials";
        ...
        {
            var responseMesage = await _client.DeleteAsync("https://localhost:7174/api/Testimonials?id=" + id);
            if (responseMesage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "AdminTestimonial", new { area = "Admin" });
            }
        ...
        {
            var responseMesage = await _client.GetAsync($"https://localhost:7174/api/Testimonials/{id}");
            if (responseMesage.IsSuccessStatusCode)
            {
                var jsonData = await responseMesage.Content.ReadAsStringAsync();
